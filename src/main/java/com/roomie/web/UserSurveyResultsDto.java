...
public class UserSurveyResultsDto {
    ...
    public UserSurveyResultsDto() {
    }

    public UserSurveyResultsDto(String whatDescribesYou, String extrovertedOrIntroverted, String inviteFriendsOver, String cleaningHabits, String doYouSmoke, String doesRoommateSmoke, String doYouDrink, String doesRoommateDrink, String sleepSchedule, String cookingHabit, String musicTaste, String havePets, String workFromHome, String petPeeves, String whatAreYouLookingFor) {
